...
public:
    ...
    sensor_msgs::Imu imuConverter(const sensor_msgs::Imu& imu_in)
    {
        ...
        // printf("imu_in.orientation_covariance[0] : %f \n", imu_in.orientation_covariance[0]);
        // printf("imu_in.orientation  : %f , %f , %f , %f \n", imu_in.orientation.w, imu_in.orientation.x, imu_in.orientation.y, imu_in.orientation.z);
        // printf("imu_out.orientation : %f , %f , %f , %f \n", imu_out.orientation.w, imu_out.orientation.x, imu_out.orientation.y, imu_out.orientation.z);
